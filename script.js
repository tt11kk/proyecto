...
function crearProblema() {
    ...
    if (nivelInfo.tipoPregunta === 'directa') {
        ...
        respuesta = (muebles * horas) / (carpinteros * carpinteros2).toFixed(nivelInfo.decimales);

        problema = {
            texto: `${carpinteros} carpinteros hacen ${muebles} muebles en ${horas} horas. ¿En cuánto tiempo ${carpinteros2} carpinteros harán el mismo número de muebles?`,
            respuesta: parseFloat(respuesta)
        };
    }
